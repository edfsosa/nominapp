        ...
        return $form
            ->schema([
                ...
                DatePicker::make('end_date')
                    ...
                    ->maxDate(now())
                    ->after('start_date')
                    ->helperText('Dejar vacío si la percepción está activa'),
                ...
                TextInput::make('custom_amount')
                    ...
                    ->step(0.01)
                    ->prefix('₲')
                    ->helperText('Opcional: anular el monto predeterminado de la percepción'),
        ...
        return $table
            ...
            ->headerActions([
                CreateAction::make()
                    ...
                    ->mutateFormDataUsing(function (array $data) {
                        $data['perception_id'] = $this->getOwnerRecord()->id;
                        $data['notes'] = $data['notes'] ?? 'Asignado desde el panel de percepciones';
                        return $data;
                    })
            ...
            ->actions([
                ...
                Action::make('deactivate')
                    ...
                    ->modalDescription('¿Está seguro de que desea remover este empleado de la percepción? Esta acción marcará la fecha de fin.')
                    ->modalSubmitActionLabel('Sí, remover')
                    ->action(function (EmployeePerception $record) {
                    ...
                    BulkAction::make('deactivate')
                        ...
                        ->action(function ($records) {
                            ...
                            Notification::make()
                                ...
                                ->body("{$count} empleado(s) removido(s) de la percepción.")
                                ->send();
                        }),
