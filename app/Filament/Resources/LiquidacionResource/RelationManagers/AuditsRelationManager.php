...
/**
 * RelationManager de historial de cambios para el módulo de Liquidaciones.
 *
...
class AuditsRelationManager extends RelationManager
{
    ...
    public function table(Table $table): Table
    {
        return $table
            ...
            ->emptyStateDescription('Los cambios de estado, cálculo y cierre de la liquidación aparecerán aquí.')
