...
/**
 * RelationManager de historial de cambios para el módulo de Períodos de Aguinaldo.
 *
...
class AuditsRelationManager extends RelationManager
{
    ...
    public function table(Table $table): Table
    {
        return $table
            ...
            ->emptyStateDescription('Los cambios de estado y cierre del período aparecerán aquí.')
