...
/**
 * RelationManager de historial de cambios para el módulo de Aguinaldo.
 *
...
class AuditsRelationManager extends RelationManager
{
    ...
    public function table(Table $table): Table
    {
        return $table
            ...
            ->emptyStateDescription('Los cambios de estado, método de pago y otros campos aparecerán aquí.')
