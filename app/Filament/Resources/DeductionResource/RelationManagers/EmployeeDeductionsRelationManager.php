        ...
        return $form
            ->schema([
                ...
                TextInput::make('custom_amount')
                    ...
                    ->step(1)
                    ->prefix('₲')
                    ->helperText('Establece un monto personalizado para este empleado. Dejar vacío para usar el monto por defecto de la deducción.'),
                ...
                Action::make('reactivate')
                    ...
                    ->form([
                        ...
                        DatePicker::make('end_date')
                            ...
                            ->displayFormat('d/m/Y')
                            ->after('start_date')
                            ->helperText('Opcional: dejar vacío si la deducción no tiene fecha de fin definida'),
                    ])
                    ->action(function (EmployeeDeduction $record, array $data) {
            ...
            ->bulkActions([
                BulkActionGroup::make([
                    BulkAction::make('deactivate')
                        ...
                        ->modalDescription('Confirmá la fecha hasta la cual aplica esta deducción para los empleados seleccionados.')
                        ->modalSubmitActionLabel('Sí, remover')
                        ->form([
                            DatePicker::make('end_date')
                                ->label('Fecha de Fin')
