...
namespace App\Filament\Resources\WarningResource\RelationManagers;
...
/**
 * RelationManager de historial de cambios para el módulo de Amonestaciones.
 *
...
class AuditsRelationManager extends RelationManager
{
    ...
    public function table(Table $table): Table
    {
        return $table
            ...
            ->emptyStateDescription('Las modificaciones al registro de la amonestación aparecerán aquí.')
