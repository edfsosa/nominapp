...
namespace App\Filament\Resources\EmployeeLeaveResource\RelationManagers;
...
/**
 * RelationManager de historial de cambios para el módulo de Permisos y Licencias.
 *
...
class AuditsRelationManager extends RelationManager
{
    ...
    public function table(Table $table): Table
    {
        return $table
            ...
            ->emptyStateDescription('Los cambios de estado, tipo y otros campos aparecerán aquí.')
