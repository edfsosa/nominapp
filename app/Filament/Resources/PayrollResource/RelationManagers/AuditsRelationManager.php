...
/**
 * RelationManager de historial de cambios para el módulo de Recibos de Nómina.
 *
...
class AuditsRelationManager extends RelationManager
{
    ...
    public function table(Table $table): Table
    {
        return $table
            ...
            ->emptyStateDescription('Los cambios de estado, acreditación y otros campos aparecerán aquí.')
