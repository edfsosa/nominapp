...
/**
 * RelationManager de historial de cambios para el módulo de Ausencias.
 *
...
class AuditsRelationManager extends RelationManager
{
    ...
    public function table(Table $table): Table
    {
        return $table
            ...
            ->emptyStateDescription('Los cambios de estado, justificación y otros campos aparecerán aquí.')
