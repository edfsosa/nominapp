...
/** RelationManager de historial de cambios para aprobaciones y ajustes de asistencia. */
class AuditsRelationManager extends RelationManager
{
    ...
    public function table(Table $table): Table
    {
        return $table
            ...
            ->emptyStateDescription('Las aprobaciones de horas extra, descuentos de tardanza y ajustes manuales aparecerán aquí.')
