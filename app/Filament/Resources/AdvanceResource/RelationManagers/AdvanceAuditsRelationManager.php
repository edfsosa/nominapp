...
namespace App\Filament\Resources\AdvanceResource\RelationManagers;
...
/**
 * RelationManager de historial de cambios para el módulo de Adelantos.
 *
 * Muestra eventos de auditoría con etiquetas en español, formatos de
 * campo legibles y sin la acción de restaurar (módulo financiero).
 */
class AdvanceAuditsRelationManager extends RelationManager
{
    ...
    public function table(Table $table): Table
    {
        return $table
            ...
            ->emptyStateDescription('Los cambios de estado, método de pago y notas aparecerán aquí.')
            ->columns([
