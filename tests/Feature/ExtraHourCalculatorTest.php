...
it('retorna resultado vacío si empleado mensual no tiene salario', function () {
    ...
    $company = Company::create(['name' => 'Empresa Sin Salario', 'ruc' => '9999991-1', 'employer_number' => 9999991]);
    $branch = Branch::create(['name' => 'Sucursal Sin Salario', 'company_id' => $company->id]);
    $employee = Employee::create([
        'first_name' => 'Sin',
        'last_name' => 'Salario',
        'ci' => '9999991',
...
it('retorna resultado vacío si jornalero no tiene tarifa diaria', function () {
    ...
    $company = Company::create(['name' => 'Empresa Sin Contrato', 'ruc' => '9999992-1', 'employer_number' => 9999992]);
    $branch = Branch::create(['name' => 'Sucursal Sin Contrato', 'company_id' => $company->id]);
    $employee = Employee::create([
        'first_name' => 'Sin',
        'last_name' => 'Contrato',
        'ci' => '9999992',
